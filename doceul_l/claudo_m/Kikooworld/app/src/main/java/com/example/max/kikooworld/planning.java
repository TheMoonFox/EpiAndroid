...
public class planning extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(planning.this, alerte.class);
            startActivity(intent);
        } else if (id == R.id.nav_notes) {
            Intent intent = new Intent(planning.this, notes.class);
            startActivity(intent);
        } else if (id == R.id.nav_messages) {
            Intent intent = new Intent(planning.this, messages.class);
            startActivity(intent);
        } else if (id == R.id.nav_modules) {
            Intent intent = new Intent(planning.this, modules.class);
            startActivity(intent);
